...
Learning objectives
Summarize the role and importance of HTML when creating websites.
Define the syntax and terminology of HTML.
...
Learning objectives
Identify the history and evolution of Node.js, including its creation and key milestones.
Understand the significance of npm and its role in the Node.js ecosystem.
Analyze the differences between the global object in Node.js and the window object in the browser.
Demonstrate how to navigate the file system using Node.js commands in the terminal.
Explain how to import and use core Node.js modules such as path, util, and v8.
Create and manage files and directories using the fs module in Node.js.
Apply the principles of the CommonJS module system to structure and reuse code in Node.js.
...
This course is part of a Professional Certificate from PagerDuty.
